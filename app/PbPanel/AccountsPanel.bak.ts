...
export class AccountsPanel extends PbPanel {
        ...
        return `
            ...
            <div class="pbrow">
                <div class="left accounts">
                    <div class="${this.classSelector.subTitle} pbrow"></div>
    ...
    protected buildOtherParts() {
        ...
        this.addPager();
        this.addItemAddBtn();
        this.addElmByTpl('if-test', '<div class="st-test"></div>');
    }
    ...
    public addElmByTpl(selector: string | HTMLElement, tpl: string) {
        // let Elm = Vue.extend({
        //         template: tpl
        //     }),
        //     elm = new Elm().$mount(selector);
        // console.log(elm);
        // return elm;
    }
}
